...
$radix=Dict::Word::radix("word");

=head1 DESCRIPTION

This module will take care of finding the radix of an Arabic word, through chopping the prefixes and suffixes of the word and by taking away unnecessary letters in the middle of the word.
